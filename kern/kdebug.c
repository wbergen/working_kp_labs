 ...
 *  For example, N_FUN stabs (stab entries with n_type == N_FUN), which mark
 *  functions, and N_SO stabs, which mark source files.
 *
 *  Given an instruction address, this function finds the single stab entry of
 *  type 'type' that contains that address.
 *
 ...
 *  *region_left points to the matching stab that contains 'addr', and
 *  *region_right points just before the next stab.
